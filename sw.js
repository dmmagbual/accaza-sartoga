...
const ASSETS=[
  ...
  '/assets/js/shared/costing.js','/assets/js/shared/recipe-temperature-plan.js','/assets/js/shared/cogs-duplication-audit.js','/assets/js/shared/serve-style-plan.js','/assets/js/admin/pos.js','/assets/js/admin/channel-pricing.js','/assets/js/admin/analytics.js','/assets/js/admin/sales-history.js','/assets/js/admin/register.js','/assets/js/admin/staff-access.js','/assets/js/admin/packages.js','/assets/js/admin/finance.js','/assets/js/admin/staff-inbox.js',
