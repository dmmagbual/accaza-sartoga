...
const ASSETS=[
  ...
  '/assets/js/pwa-register.js','/assets/css/admin-backoffice.css','/assets/js/shared/business-date.js','/assets/js/shared/sales-authority.js',
  ...
  '/assets/js/admin/core.mjs','/assets/js/admin/archive-order-sort.mjs','/assets/js/admin/workspace-shell.mjs','/assets/js/admin/overview-command.mjs','/assets/js/admin/overview-insights.mjs','/assets/js/admin/firebase-client.mjs','/assets/js/admin/realtime-hub.mjs','/assets/js/admin/history-pager.mjs','/assets/js/admin/manager-approval.mjs','/assets/js/admin/portal-auth.mjs','/assets/js/admin/admin-orders.mjs','/assets/js/admin/customer-registry.mjs','/assets/js/admin/reservations.mjs','/assets/js/admin/catalog-admin.mjs','/assets/js/admin/app-customer-session.mjs','/assets/js/admin/customer-order-tracker.mjs','/assets/js/admin/shared-ui.mjs','/assets/js/admin/telemetry.js','/assets/js/admin/operations-dashboard.js','/assets/js/admin/form-dialog.js','/assets/js/admin/module-loader.js','/assets/js/admin/offline-queue.js','/assets/js/admin/portal-boot.js',
  '/assets/js/shared/costing.js','/assets/js/admin/pos.js','/assets/js/admin/channel-pricing.js','/assets/js/admin/analytics.js','/assets/js/admin/sales-history.js','/assets/js/admin/register.js','/assets/js/admin/staff-access.js','/assets/js/admin/packages.js','/assets/js/admin/finance.js'
];
