...
const ASSETS=[
  ...
  '/assets/css/books.css','/assets/js/books/app.js','/src/books/business-intelligence.js','/assets/js/books/live-pos.mjs','/assets/js/books/accounting-periods.mjs'
];
