...
const ASSETS=[
  ...
  '/assets/js/pwa-register.js','/assets/css/admin-backoffice.css','/assets/js/shared/text-encoding.js','/assets/js/shared/business-date.js','/assets/js/shared/sales-authority.js',
