...
const CACHE='accaza-v570';
const ASSETS=[
  '/index.html','/manifest.json',
  '/favicon.ico','/favicon_32x32.png','/favicon_180x180.png','/favicon_192x192.png',
  '/assets/js/pwa-register.js','/assets/js/shared/build-freshness.js','/build-version.json','/assets/css/customer/app-shell.css','/assets/css/customer/retired-admin.css','/assets/css/customer/site.css','/assets/css/customer/packages.css',
...
const ADMIN_ASSETS=[
  ...
  '/assets/css/books.css','/assets/js/shared/cash-flow-basis.js','/assets/js/books/app.js','/src/books/csv-exports.js','/src/books/business-intelligence.js','/src/books/opening-payables.js','/assets/js/books/live-pos.mjs','/assets/js/books/suspense-advance.mjs','/assets/js/books/accounting-periods.mjs'
];
