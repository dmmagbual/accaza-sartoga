...
if((combined.match(/\bfail\(/g)||[]).length!==505)throw new Error('Static-check failure-guard inventory changed from the Phase 8 baseline of 505');
...
if(guardDigest!=='a69b5dcd22a1f7f8b5116dc63c0dc5f5064170b8d5ad35b05d59aad847182317')throw new Error('Static-check guard source changed; review the assertion-level change and update the Phase 8 baseline deliberately');
...
console.log('PASS: all 505 static guards and 30 executable checks remain byte-equivalent and routed through bounded domain modules.');
