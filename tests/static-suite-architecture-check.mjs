...
if((combined.match(/\bfail\(/g)||[]).length!==533)throw new Error('Static-check failure-guard inventory changed from the reviewed baseline of 533');
...
if(guardDigest!=='6cf35a7128d4b32d996da688e5898c92d6299b74404e11303058f58600caa359')throw new Error('Static-check guard source changed; review the assertion-level change and update the Phase 18 baseline deliberately');
...
console.log('PASS: all 533 static guards and 31 executable checks remain byte-equivalent and routed through bounded domain modules.');
