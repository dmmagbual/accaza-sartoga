...
if((combined.match(/\bfail\(/g)||[]).length!==543)throw new Error('Static-check failure-guard inventory changed from the reviewed baseline of 543');
...
if(guardDigest!=='44799ad991f766d7fb91d45b2e4ec2943d0bc6d6e635be9bf2c06cb6da04d5cf')throw new Error('Static-check guard source changed; review the assertion-level change and update the baseline deliberately');
...
console.log('PASS: all 543 static guards and 32 executable checks remain byte-equivalent and routed through bounded domain modules.');
