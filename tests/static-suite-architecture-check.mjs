...
if((combined.match(/\bfail\(/g)||[]).length!==516)throw new Error('Static-check failure-guard inventory changed from the reviewed baseline of 516');
...
if(guardDigest!=='2eb50c4ddcfacc9cf778bdebcb1fd4fca48788d588908f72397be54733507269')throw new Error('Static-check guard source changed; review the assertion-level change and update the Phase 18 baseline deliberately');
...
console.log('PASS: all 516 static guards and 30 executable checks remain byte-equivalent and routed through bounded domain modules.');
