...
if((combined.match(/\bfail\(/g)||[]).length!==532)throw new Error('Static-check failure-guard inventory changed from the reviewed baseline of 532');
...
if(guardDigest!=='ad1e171cbb9ac77f57bf7b89fc7344249fea92d7ca9ee3ea59f5244e4a88de77')throw new Error('Static-check guard source changed; review the assertion-level change and update the Phase 18 baseline deliberately');
...
console.log('PASS: all 532 static guards and 31 executable checks remain byte-equivalent and routed through bounded domain modules.');
