...
if((combined.match(/\bfail\(/g)||[]).length!==536)throw new Error('Static-check failure-guard inventory changed from the reviewed baseline of 536');
...
if(guardDigest!=='ff74a224d88fe0ad5da8bd55a3fbed4216a849f9c917aa98f235758239436d42')throw new Error('Static-check guard source changed; review the assertion-level change and update the baseline deliberately');
...
console.log('PASS: all 536 static guards and 32 executable checks remain byte-equivalent and routed through bounded domain modules.');
