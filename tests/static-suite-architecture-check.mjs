...
if((combined.match(/\bfail\(/g)||[]).length!==522)throw new Error('Static-check failure-guard inventory changed from the reviewed baseline of 522');
...
if(guardDigest!=='5da7ef37a4557c65462453212d14fb55c031e6474dea33a6af9f25ffef50d82d')throw new Error('Static-check guard source changed; review the assertion-level change and update the Phase 18 baseline deliberately');
...
console.log('PASS: all 522 static guards and 31 executable checks remain byte-equivalent and routed through bounded domain modules.');
