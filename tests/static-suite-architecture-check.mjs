...
if((combined.match(/\bfail\(/g)||[]).length!==510)throw new Error('Static-check failure-guard inventory changed from the Phase 16 baseline of 510');
...
if(guardDigest!=='b72b607e32c721b3d780fd37ccc982caff8ef2071f607fc91f220332a4587e1a')throw new Error('Static-check guard source changed; review the assertion-level change and update the Phase 16 baseline deliberately');
...
console.log('PASS: all 510 static guards and 30 executable checks remain byte-equivalent and routed through bounded domain modules.');
