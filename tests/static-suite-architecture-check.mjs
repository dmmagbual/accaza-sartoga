...
if(guardDigest!=='f4522aaeca15f88ae51fb75bfbd9bdd81022f7925677ee9b10ddc5d822c26aaf')throw new Error('Static-check guard source changed; review the assertion-level change and update the baseline deliberately');
