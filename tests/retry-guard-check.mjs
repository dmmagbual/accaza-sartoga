...
// newly retries, add it to the --force line in .github/workflows/deploy-functions.yml.
{
  ...
  const reviewed = ['markBackupDirtyActivityLog', 'markBackupDirtyAppCustomers', 'markBackupDirtyArchivedOrders', 'markBackupDirtyBooksJournal', 'markBackupDirtyCashBalanceApplied', 'markBackupDirtyCfLedger', 'markBackupDirtyFeedbacks', 'markBackupDirtyFinancialApprovals', 'markBackupDirtyFinancialCommandClaims', 'markBackupDirtyFinancialMovements', 'markBackupDirtyInternalUsage', 'markBackupDirtyInventoryAccounting', 'markBackupDirtyInventoryAdjustments', 'markBackupDirtyInventoryMovements', 'markBackupDirtyInventorySku', 'markBackupDirtyOperationalAudit', 'markBackupDirtyOrderInventoryPlans', 'markBackupDirtyPackages', 'markBackupDirtyPayables', 'markBackupDirtyPettyCashReceipts', 'markBackupDirtyPettyCashReplenishments', 'markBackupDirtyPettyCashVouchers', 'markBackupDirtyPlatformPayouts', 'markBackupDirtyPurchaseInvoices', 'markBackupDirtyReceivables', 'markBackupDirtyReviews', 'markBackupDirtyShifts', 'markBackupDirtyStockReceipts', 'markBackupDirtySuppliers', 'onOrderFinalize', 'onOrderFinancialPosting', 'onOrderInventoryReversal', 'onPettyReplenishmentFinancial', 'onPettyVoucherFinancial', 'onShiftCloseAssurance', 'onShiftCloseFinancial', 'onShiftOpenFinancial', 'onShiftPayInsFinancial', 'onShiftPayOutsFinancial', 'preservePostedOrderOnDelete', 'refreshHistoricalOrderAfterInventoryPlan', 'refreshHistoricalOrderAfterJournal', 'replicateArchivedOrderToFirestore', 'syncCashCustodyPageIndex', 'syncPettyVoucherAttentionIndex', 'syncUndepositedLedgerPageIndex', 'updateBooksMonthlyNet', 'updateCashBalanceSummary', 'updatePublicCatalogVersionOnCategories', 'updatePublicCatalogVersionOnMenuItems', 'updatePublicCatalogVersionOnOptionGroups', 'updatePublicCatalogVersionOnPackages'];
