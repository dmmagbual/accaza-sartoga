...
if(!functionsSource.includes('const ACCAZA_AI_RELEASE_VERSION = "1.1"')||!functionsSource.includes('releaseVersion:ACCAZA_AI_RELEASE_VERSION'))throw new Error('Accaza AI must return its explicit release version for deployment verification.');
