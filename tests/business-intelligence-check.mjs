...
if(manifest.builds.admin!==474||manifest.builds.books!==106||manifest.builds.serviceWorkerCache!==445)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v445'/.test(sw))throw new Error('Service worker cache 445 is not synchronized');
