...
if(manifest.builds.admin!==442||manifest.builds.books!==97||manifest.builds.serviceWorkerCache!==405)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v405'/.test(sw))throw new Error('Service worker cache 405 is not synchronized');
