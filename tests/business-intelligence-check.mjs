...
if(manifest.builds.admin!==519||manifest.builds.books!==115||manifest.builds.serviceWorkerCache!==496)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v496'/.test(sw))throw new Error('Service worker cache 496 is not synchronized');
