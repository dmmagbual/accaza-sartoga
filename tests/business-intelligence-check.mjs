...
if(manifest.builds.admin!==448||manifest.builds.books!==100||manifest.builds.serviceWorkerCache!==415)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v415'/.test(sw))throw new Error('Service worker cache 415 is not synchronized');
