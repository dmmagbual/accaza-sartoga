...
if(manifest.builds.admin!==528||manifest.builds.books!==115||manifest.builds.serviceWorkerCache!==505)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v505'/.test(sw))throw new Error('Service worker cache 505 is not synchronized');
