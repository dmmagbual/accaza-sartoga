...
if(manifest.builds.admin!==585||manifest.builds.books!==129||manifest.builds.serviceWorkerCache!==566)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v566'/.test(sw))throw new Error('Service worker cache is not synchronized');
