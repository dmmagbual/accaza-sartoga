...
if(manifest.builds.admin!==457||manifest.builds.books!==105||manifest.builds.serviceWorkerCache!==428)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v428'/.test(sw))throw new Error('Service worker cache 428 is not synchronized');
