...
if(manifest.builds.admin!==560||manifest.builds.books!==128||manifest.builds.serviceWorkerCache!==541)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v541'/.test(sw))throw new Error('Service worker cache is not synchronized');
