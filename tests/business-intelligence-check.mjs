...
if(manifest.builds.admin!==575||manifest.builds.books!==129||manifest.builds.serviceWorkerCache!==556)throw new Error('Release manifest build markers are not synchronized');
