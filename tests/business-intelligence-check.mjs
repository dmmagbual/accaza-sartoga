...
if(manifest.builds.admin!==429||manifest.builds.books!==97||manifest.builds.serviceWorkerCache!==392)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v392'/.test(sw))throw new Error('Service worker cache 392 is not synchronized');
