...
if(manifest.builds.admin!==556||manifest.builds.books!==128||manifest.builds.serviceWorkerCache!==537)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v537'/.test(sw))throw new Error('Service worker cache is not synchronized');
