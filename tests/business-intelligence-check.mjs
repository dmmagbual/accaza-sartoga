...
if(manifest.builds.admin!==414||manifest.builds.books!==94||manifest.builds.serviceWorkerCache!==375)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v375'/.test(sw))throw new Error('Service worker cache 375 is not synchronized');
