...
if(manifest.builds.admin!==407||manifest.builds.books!==85||manifest.builds.serviceWorkerCache!==362)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v362'/.test(sw))throw new Error('Service worker cache 362 is not synchronized');
