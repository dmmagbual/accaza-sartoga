...
if(manifest.builds.admin!==531||manifest.builds.books!==115||manifest.builds.serviceWorkerCache!==508)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v508'/.test(sw))throw new Error('Service worker cache 508 is not synchronized');
