...
if(manifest.builds.admin!==510||manifest.builds.books!==113||manifest.builds.serviceWorkerCache!==485)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v485'/.test(sw))throw new Error('Service worker cache 485 is not synchronized');
