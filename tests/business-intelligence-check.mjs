...
if(manifest.builds.admin!==460||manifest.builds.books!==105||manifest.builds.serviceWorkerCache!==431)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v431'/.test(sw))throw new Error('Service worker cache 431 is not synchronized');
