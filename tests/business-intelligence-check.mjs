...
if(manifest.builds.admin!==466||manifest.builds.books!==105||manifest.builds.serviceWorkerCache!==437)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v437'/.test(sw))throw new Error('Service worker cache 437 is not synchronized');
