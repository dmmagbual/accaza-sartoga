...
if(manifest.builds.admin!==406||manifest.builds.books!==85||manifest.builds.serviceWorkerCache!==361)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v361'/.test(sw))throw new Error('Service worker cache 361 is not synchronized');
