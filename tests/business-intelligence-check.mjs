...
if(manifest.builds.admin!==444||manifest.builds.books!==97||manifest.builds.serviceWorkerCache!==407)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v407'/.test(sw))throw new Error('Service worker cache 407 is not synchronized');
