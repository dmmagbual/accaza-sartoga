...
if(manifest.builds.admin!==579||manifest.builds.books!==129||manifest.builds.serviceWorkerCache!==560)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v560'/.test(sw))throw new Error('Service worker cache is not synchronized');
