...
if(manifest.builds.admin!==574||manifest.builds.books!==129||manifest.builds.serviceWorkerCache!==556)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v556'/.test(sw))throw new Error('Service worker cache is not synchronized');
