...
if(manifest.builds.admin!==532||manifest.builds.books!==115||manifest.builds.serviceWorkerCache!==509)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v509'/.test(sw))throw new Error('Service worker cache 509 is not synchronized');
