...
if(manifest.builds.admin!==508||manifest.builds.books!==113||manifest.builds.serviceWorkerCache!==483)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v483'/.test(sw))throw new Error('Service worker cache 483 is not synchronized');
