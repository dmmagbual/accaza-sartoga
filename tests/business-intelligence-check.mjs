...
if(manifest.builds.admin!==558||manifest.builds.books!==128||manifest.builds.serviceWorkerCache!==539)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v539'/.test(sw))throw new Error('Service worker cache is not synchronized');
