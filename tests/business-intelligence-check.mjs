...
if(manifest.builds.admin!==559||manifest.builds.books!==128||manifest.builds.serviceWorkerCache!==540)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v540'/.test(sw))throw new Error('Service worker cache is not synchronized');
