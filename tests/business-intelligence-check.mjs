...
if(manifest.builds.admin!==475||manifest.builds.books!==106||manifest.builds.serviceWorkerCache!==446)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v446'/.test(sw))throw new Error('Service worker cache 446 is not synchronized');
