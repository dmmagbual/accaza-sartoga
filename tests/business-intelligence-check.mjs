...
if(manifest.builds.admin!==456||manifest.builds.books!==105||manifest.builds.serviceWorkerCache!==427)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v427'/.test(sw))throw new Error('Service worker cache 427 is not synchronized');
