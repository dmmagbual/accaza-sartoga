...
if(manifest.builds.admin!==433||manifest.builds.books!==97||manifest.builds.serviceWorkerCache!==396)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v396'/.test(sw))throw new Error('Service worker cache 396 is not synchronized');
