...
if(manifest.builds.admin!==503||manifest.builds.books!==112||manifest.builds.serviceWorkerCache!==478)throw new Error('Release manifest build markers are not synchronized');
