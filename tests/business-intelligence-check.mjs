...
if(manifest.builds.admin!==516||manifest.builds.books!==115||manifest.builds.serviceWorkerCache!==493)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v493'/.test(sw))throw new Error('Service worker cache 493 is not synchronized');
