...
if(manifest.builds.admin!==507||manifest.builds.books!==113||manifest.builds.serviceWorkerCache!==482)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v482'/.test(sw))throw new Error('Service worker cache 482 is not synchronized');
