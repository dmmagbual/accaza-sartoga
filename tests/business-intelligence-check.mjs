...
if(manifest.builds.admin!==479||manifest.builds.books!==107||manifest.builds.serviceWorkerCache!==451)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v451'/.test(sw))throw new Error('Service worker cache 451 is not synchronized');
