...
if(manifest.builds.admin!==522||manifest.builds.books!==115||manifest.builds.serviceWorkerCache!==499)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v499'/.test(sw))throw new Error('Service worker cache 499 is not synchronized');
