...
if(manifest.builds.admin!==568||manifest.builds.books!==129||manifest.builds.serviceWorkerCache!==549)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v549'/.test(sw))throw new Error('Service worker cache is not synchronized');
