...
if(manifest.builds.admin!==581||manifest.builds.books!==129||manifest.builds.serviceWorkerCache!==562)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v562'/.test(sw))throw new Error('Service worker cache is not synchronized');
