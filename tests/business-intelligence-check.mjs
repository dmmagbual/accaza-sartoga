...
if(manifest.builds.admin!==554||manifest.builds.books!==128||manifest.builds.serviceWorkerCache!==535)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v535'/.test(sw))throw new Error('Service worker cache is not synchronized');
