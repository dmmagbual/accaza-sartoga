...
if(manifest.builds.admin!==580||manifest.builds.books!==129||manifest.builds.serviceWorkerCache!==561)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v561'/.test(sw))throw new Error('Service worker cache is not synchronized');
