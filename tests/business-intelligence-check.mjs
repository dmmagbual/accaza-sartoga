...
if(manifest.builds.admin!==517||manifest.builds.books!==115||manifest.builds.serviceWorkerCache!==494)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v494'/.test(sw))throw new Error('Service worker cache 494 is not synchronized');
