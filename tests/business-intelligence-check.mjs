...
if(manifest.builds.admin!==506||manifest.builds.books!==113||manifest.builds.serviceWorkerCache!==481)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v481'/.test(sw))throw new Error('Service worker cache 481 is not synchronized');
