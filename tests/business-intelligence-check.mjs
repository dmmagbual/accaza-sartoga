...
if(manifest.builds.admin!==498||manifest.builds.books!==109||manifest.builds.serviceWorkerCache!==473)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v473'/.test(sw))throw new Error('Service worker cache 473 is not synchronized');
