...
if(manifest.builds.admin!==520||manifest.builds.books!==115||manifest.builds.serviceWorkerCache!==497)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v497'/.test(sw))throw new Error('Service worker cache 497 is not synchronized');
