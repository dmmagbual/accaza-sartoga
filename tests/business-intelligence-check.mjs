...
if(manifest.builds.admin!==477||manifest.builds.books!==107||manifest.builds.serviceWorkerCache!==449)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v449'/.test(sw))throw new Error('Service worker cache 449 is not synchronized');
