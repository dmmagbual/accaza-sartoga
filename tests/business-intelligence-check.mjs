...
if(manifest.builds.admin!==438||manifest.builds.books!==97||manifest.builds.serviceWorkerCache!==401)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v401'/.test(sw))throw new Error('Service worker cache 401 is not synchronized');
