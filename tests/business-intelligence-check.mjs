...
if(manifest.builds.admin!==486||manifest.builds.books!==108||manifest.builds.serviceWorkerCache!==459)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v459'/.test(sw))throw new Error('Service worker cache 459 is not synchronized');
