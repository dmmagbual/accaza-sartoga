...
if(manifest.builds.admin!==504||manifest.builds.books!==113||manifest.builds.serviceWorkerCache!==479)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v479'/.test(sw))throw new Error('Service worker cache 479 is not synchronized');
