...
if(manifest.builds.admin!==566||manifest.builds.books!==129||manifest.builds.serviceWorkerCache!==547)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v547'/.test(sw))throw new Error('Service worker cache is not synchronized');
