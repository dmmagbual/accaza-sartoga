...
if(manifest.builds.admin!==583||manifest.builds.books!==129||manifest.builds.serviceWorkerCache!==564)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v564'/.test(sw))throw new Error('Service worker cache is not synchronized');
