...
if(manifest.builds.admin!==521||manifest.builds.books!==115||manifest.builds.serviceWorkerCache!==498)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v498'/.test(sw))throw new Error('Service worker cache 498 is not synchronized');
