...
if(manifest.builds.admin!==494||manifest.builds.books!==109||manifest.builds.serviceWorkerCache!==469)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v469'/.test(sw))throw new Error('Service worker cache 469 is not synchronized');
