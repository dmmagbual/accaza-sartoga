...
if(manifest.builds.admin!==573||manifest.builds.books!==129||manifest.builds.serviceWorkerCache!==554)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v554'/.test(sw))throw new Error('Service worker cache is not synchronized');
