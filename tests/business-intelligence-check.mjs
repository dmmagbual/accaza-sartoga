...
if(manifest.builds.admin!==478||manifest.builds.books!==107||manifest.builds.serviceWorkerCache!==450)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v450'/.test(sw))throw new Error('Service worker cache 450 is not synchronized');
