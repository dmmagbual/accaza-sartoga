...
if(manifest.builds.admin!==424||manifest.builds.books!==95||manifest.builds.serviceWorkerCache!==385)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v385'/.test(sw))throw new Error('Service worker cache 385 is not synchronized');
