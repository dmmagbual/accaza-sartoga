...
if(manifest.builds.admin!==429||manifest.builds.books!==96||manifest.builds.serviceWorkerCache!==391)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v391'/.test(sw))throw new Error('Service worker cache 391 is not synchronized');
