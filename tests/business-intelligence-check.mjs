...
if(manifest.builds.admin!==595||manifest.builds.books!==129||manifest.builds.serviceWorkerCache!==573)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v573'/.test(sw))throw new Error('Service worker cache is not synchronized');
