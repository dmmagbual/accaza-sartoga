...
if(manifest.builds.admin!==448||manifest.builds.books!==101||manifest.builds.serviceWorkerCache!==416)throw new Error('Release manifest build markers are not synchronized');
