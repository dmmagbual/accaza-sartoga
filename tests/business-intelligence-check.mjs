...
if(manifest.builds.admin!==524||manifest.builds.books!==115||manifest.builds.serviceWorkerCache!==501)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v501'/.test(sw))throw new Error('Service worker cache 501 is not synchronized');
