...
if(manifest.builds.admin!==465||manifest.builds.books!==105||manifest.builds.serviceWorkerCache!==436)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v436'/.test(sw))throw new Error('Service worker cache 436 is not synchronized');
