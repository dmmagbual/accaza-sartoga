...
if(manifest.builds.admin!==551||manifest.builds.books!==126||manifest.builds.serviceWorkerCache!==531)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v531'/.test(sw))throw new Error('Service worker cache is not synchronized');
