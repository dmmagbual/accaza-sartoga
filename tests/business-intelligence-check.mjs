...
if(manifest.builds.admin!==509||manifest.builds.books!==113||manifest.builds.serviceWorkerCache!==484)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v484'/.test(sw))throw new Error('Service worker cache 484 is not synchronized');
