...
if(manifest.builds.admin!==476||manifest.builds.books!==107||manifest.builds.serviceWorkerCache!==448)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v448'/.test(sw))throw new Error('Service worker cache 448 is not synchronized');
