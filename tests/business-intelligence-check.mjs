...
if(manifest.builds.admin!==540||manifest.builds.books!==122||manifest.builds.serviceWorkerCache!==518)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v518'/.test(sw))throw new Error('Service worker cache 515 is not synchronized');
