...
if(manifest.builds.admin!==463||manifest.builds.books!==105||manifest.builds.serviceWorkerCache!==434)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v434'/.test(sw))throw new Error('Service worker cache 434 is not synchronized');
