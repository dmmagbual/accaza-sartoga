...
if(manifest.builds.admin!==419||manifest.builds.books!==94||manifest.builds.serviceWorkerCache!==380)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v380'/.test(sw))throw new Error('Service worker cache 380 is not synchronized');
