...
if(manifest.builds.admin!==417||manifest.builds.books!==94||manifest.builds.serviceWorkerCache!==378)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v378'/.test(sw))throw new Error('Service worker cache 378 is not synchronized');
