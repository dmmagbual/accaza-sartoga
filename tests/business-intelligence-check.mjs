...
if(manifest.builds.admin!==416||manifest.builds.books!==94||manifest.builds.serviceWorkerCache!==377)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v377'/.test(sw))throw new Error('Service worker cache 377 is not synchronized');
