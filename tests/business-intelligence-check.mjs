...
if(manifest.builds.admin!==511||manifest.builds.books!==113||manifest.builds.serviceWorkerCache!==486)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v486'/.test(sw))throw new Error('Service worker cache 486 is not synchronized');
