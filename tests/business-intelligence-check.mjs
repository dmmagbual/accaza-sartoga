...
if(manifest.builds.admin!==443||manifest.builds.books!==97||manifest.builds.serviceWorkerCache!==406)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v406'/.test(sw))throw new Error('Service worker cache 406 is not synchronized');
