...
if(manifest.builds.admin!==555||manifest.builds.books!==128||manifest.builds.serviceWorkerCache!==536)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v536'/.test(sw))throw new Error('Service worker cache is not synchronized');
