...
if(manifest.builds.admin!==485||manifest.builds.books!==107||manifest.builds.serviceWorkerCache!==457)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v457'/.test(sw))throw new Error('Service worker cache 457 is not synchronized');
