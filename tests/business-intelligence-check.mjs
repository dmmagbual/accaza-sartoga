...
if(manifest.builds.admin!==420||manifest.builds.books!==95||manifest.builds.serviceWorkerCache!==381)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v381'/.test(sw))throw new Error('Service worker cache 381 is not synchronized');
