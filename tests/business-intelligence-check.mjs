...
if(manifest.builds.admin!==472||manifest.builds.books!==106||manifest.builds.serviceWorkerCache!==443)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v443'/.test(sw))throw new Error('Service worker cache 443 is not synchronized');
