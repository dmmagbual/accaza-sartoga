...
if(manifest.builds.admin!==569||manifest.builds.books!==129||manifest.builds.serviceWorkerCache!==550)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v550'/.test(sw))throw new Error('Service worker cache is not synchronized');
