...
if(manifest.builds.admin!==455||manifest.builds.books!==105||manifest.builds.serviceWorkerCache!==426)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v426'/.test(sw))throw new Error('Service worker cache 426 is not synchronized');
