...
if(manifest.builds.admin!==428||manifest.builds.books!==96||manifest.builds.serviceWorkerCache!==390)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v390'/.test(sw))throw new Error('Service worker cache 390 is not synchronized');
