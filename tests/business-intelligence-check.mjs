...
if(manifest.builds.admin!==482||manifest.builds.books!==107||manifest.builds.serviceWorkerCache!==454)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v454'/.test(sw))throw new Error('Service worker cache 454 is not synchronized');
