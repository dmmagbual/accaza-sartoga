...
if(manifest.builds.admin!==426||manifest.builds.books!==96||manifest.builds.serviceWorkerCache!==388)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v388'/.test(sw))throw new Error('Service worker cache 388 is not synchronized');
