...
if(manifest.builds.admin!==570||manifest.builds.books!==129||manifest.builds.serviceWorkerCache!==551)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v551'/.test(sw))throw new Error('Service worker cache is not synchronized');
