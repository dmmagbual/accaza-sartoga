...
if(manifest.builds.admin!==561||manifest.builds.books!==128||manifest.builds.serviceWorkerCache!==542)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v542'/.test(sw))throw new Error('Service worker cache is not synchronized');
