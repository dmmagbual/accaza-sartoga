...
if(manifest.builds.admin!==578||manifest.builds.books!==129||manifest.builds.serviceWorkerCache!==559)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v559'/.test(sw))throw new Error('Service worker cache is not synchronized');
