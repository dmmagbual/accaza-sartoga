...
if(manifest.builds.admin!==425||manifest.builds.books!==95||manifest.builds.serviceWorkerCache!==386)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v386'/.test(sw))throw new Error('Service worker cache 386 is not synchronized');
