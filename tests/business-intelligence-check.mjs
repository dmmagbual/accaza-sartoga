...
if(manifest.builds.admin!==489||manifest.builds.books!==108||manifest.builds.serviceWorkerCache!==464)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v464'/.test(sw))throw new Error('Service worker cache 464 is not synchronized');
