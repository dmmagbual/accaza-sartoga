...
if(manifest.builds.admin!==437||manifest.builds.books!==97||manifest.builds.serviceWorkerCache!==400)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v400'/.test(sw))throw new Error('Service worker cache 400 is not synchronized');
