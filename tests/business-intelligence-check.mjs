...
if(manifest.builds.admin!==452||manifest.builds.books!==105||manifest.builds.serviceWorkerCache!==423)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v423'/.test(sw))throw new Error('Service worker cache 423 is not synchronized');
