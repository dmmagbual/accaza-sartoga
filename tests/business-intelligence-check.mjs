...
if(manifest.builds.admin!==563||manifest.builds.books!==128||manifest.builds.serviceWorkerCache!==544)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v544'/.test(sw))throw new Error('Service worker cache is not synchronized');
