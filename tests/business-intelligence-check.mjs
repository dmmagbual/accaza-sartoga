...
if(manifest.builds.admin!==434||manifest.builds.books!==97||manifest.builds.serviceWorkerCache!==397)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v397'/.test(sw))throw new Error('Service worker cache 397 is not synchronized');
