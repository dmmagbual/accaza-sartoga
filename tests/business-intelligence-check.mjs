...
if(manifest.builds.admin!==577||manifest.builds.books!==129||manifest.builds.serviceWorkerCache!==558)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v558'/.test(sw))throw new Error('Service worker cache is not synchronized');
