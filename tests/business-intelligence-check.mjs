...
if(manifest.builds.admin!==571||manifest.builds.books!==129||manifest.builds.serviceWorkerCache!==552)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v552'/.test(sw))throw new Error('Service worker cache is not synchronized');
