...
if(manifest.builds.admin!==487||manifest.builds.books!==108||manifest.builds.serviceWorkerCache!==460)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v460'/.test(sw))throw new Error('Service worker cache 460 is not synchronized');
