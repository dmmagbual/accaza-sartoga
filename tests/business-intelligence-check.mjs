...
if(manifest.builds.admin!==543||manifest.builds.books!==123||manifest.builds.serviceWorkerCache!==521)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v521'/.test(sw))throw new Error('Service worker cache is not synchronized');
