...
if(manifest.builds.admin!==436||manifest.builds.books!==97||manifest.builds.serviceWorkerCache!==399)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v399'/.test(sw))throw new Error('Service worker cache 399 is not synchronized');
