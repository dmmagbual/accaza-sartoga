...
if(manifest.builds.admin!==576||manifest.builds.books!==129||manifest.builds.serviceWorkerCache!==557)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v557'/.test(sw))throw new Error('Service worker cache is not synchronized');
