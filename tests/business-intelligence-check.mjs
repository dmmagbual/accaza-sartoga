...
if(manifest.builds.admin!==432||manifest.builds.books!==97||manifest.builds.serviceWorkerCache!==395)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v395'/.test(sw))throw new Error('Service worker cache 395 is not synchronized');
