...
if(manifest.builds.admin!==547||manifest.builds.books!==124||manifest.builds.serviceWorkerCache!==526)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v526'/.test(sw))throw new Error('Service worker cache is not synchronized');
