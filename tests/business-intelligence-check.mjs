...
if(manifest.builds.admin!==514||manifest.builds.books!==115||manifest.builds.serviceWorkerCache!==491)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v491'/.test(sw))throw new Error('Service worker cache 491 is not synchronized');
