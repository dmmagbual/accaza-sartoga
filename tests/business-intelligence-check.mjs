...
if(manifest.builds.admin!==422||manifest.builds.books!==95||manifest.builds.serviceWorkerCache!==383)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v383'/.test(sw))throw new Error('Service worker cache 383 is not synchronized');
