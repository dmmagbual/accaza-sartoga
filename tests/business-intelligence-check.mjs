...
if(manifest.builds.admin!==473||manifest.builds.books!==106||manifest.builds.serviceWorkerCache!==444)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v444'/.test(sw))throw new Error('Service worker cache 444 is not synchronized');
