...
if(manifest.builds.admin!==492||manifest.builds.books!==109||manifest.builds.serviceWorkerCache!==467)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v467'/.test(sw))throw new Error('Service worker cache 467 is not synchronized');
