...
if(manifest.builds.admin!==446||manifest.builds.books!==97||manifest.builds.serviceWorkerCache!==410)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v410'/.test(sw))throw new Error('Service worker cache 410 is not synchronized');
