...
if(manifest.builds.admin!==587||manifest.builds.books!==129||manifest.builds.serviceWorkerCache!==568)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v568'/.test(sw))throw new Error('Service worker cache is not synchronized');
