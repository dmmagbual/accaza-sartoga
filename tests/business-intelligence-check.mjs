...
if(manifest.builds.admin!==421||manifest.builds.books!==95||manifest.builds.serviceWorkerCache!==382)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v382'/.test(sw))throw new Error('Service worker cache 382 is not synchronized');
