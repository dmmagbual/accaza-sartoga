...
if(manifest.builds.admin!==545||manifest.builds.books!==123||manifest.builds.serviceWorkerCache!==523)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v523'/.test(sw))throw new Error('Service worker cache is not synchronized');
