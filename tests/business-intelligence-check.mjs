...
if(manifest.builds.admin!==544||manifest.builds.books!==123||manifest.builds.serviceWorkerCache!==522)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v522'/.test(sw))throw new Error('Service worker cache is not synchronized');
