...
if(manifest.builds.admin!==459||manifest.builds.books!==105||manifest.builds.serviceWorkerCache!==430)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v430'/.test(sw))throw new Error('Service worker cache 430 is not synchronized');
