...
if(manifest.builds.admin!==462||manifest.builds.books!==105||manifest.builds.serviceWorkerCache!==433)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v433'/.test(sw))throw new Error('Service worker cache 433 is not synchronized');
