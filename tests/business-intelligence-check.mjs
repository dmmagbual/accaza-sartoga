...
if(manifest.builds.admin!==468||manifest.builds.books!==105||manifest.builds.serviceWorkerCache!==439)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v439'/.test(sw))throw new Error('Service worker cache 439 is not synchronized');
