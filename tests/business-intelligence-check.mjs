...
if(manifest.builds.admin!==515||manifest.builds.books!==115||manifest.builds.serviceWorkerCache!==492)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v492'/.test(sw))throw new Error('Service worker cache 492 is not synchronized');
