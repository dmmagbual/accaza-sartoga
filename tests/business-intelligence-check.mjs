...
if(manifest.builds.admin!==448||manifest.builds.books!==99||manifest.builds.serviceWorkerCache!==414)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v414'/.test(sw))throw new Error('Service worker cache 414 is not synchronized');
