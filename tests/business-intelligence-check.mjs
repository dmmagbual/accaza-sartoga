...
if(manifest.builds.admin!==534||manifest.builds.books!==116||manifest.builds.serviceWorkerCache!==511)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v511'/.test(sw))throw new Error('Service worker cache 511 is not synchronized');
