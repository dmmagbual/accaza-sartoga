...
if(manifest.builds.admin!==435||manifest.builds.books!==97||manifest.builds.serviceWorkerCache!==398)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v398'/.test(sw))throw new Error('Service worker cache 398 is not synchronized');
