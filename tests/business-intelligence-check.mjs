...
if(manifest.builds.admin!==495||manifest.builds.books!==109||manifest.builds.serviceWorkerCache!==470)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v470'/.test(sw))throw new Error('Service worker cache 470 is not synchronized');
