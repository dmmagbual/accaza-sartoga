...
if(manifest.builds.admin!==564||manifest.builds.books!==129||manifest.builds.serviceWorkerCache!==545)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v545'/.test(sw))throw new Error('Service worker cache is not synchronized');
