...
if(manifest.builds.admin!==440||manifest.builds.books!==97||manifest.builds.serviceWorkerCache!==403)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v403'/.test(sw))throw new Error('Service worker cache 403 is not synchronized');
