...
if(manifest.builds.admin!==525||manifest.builds.books!==115||manifest.builds.serviceWorkerCache!==502)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v502'/.test(sw))throw new Error('Service worker cache 502 is not synchronized');
