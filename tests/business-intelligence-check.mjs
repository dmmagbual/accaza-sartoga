...
if(manifest.builds.admin!==565||manifest.builds.books!==129||manifest.builds.serviceWorkerCache!==546)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v546'/.test(sw))throw new Error('Service worker cache is not synchronized');
