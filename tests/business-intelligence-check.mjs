...
if(manifest.builds.admin!==487||manifest.builds.books!==108||manifest.builds.serviceWorkerCache!==461)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v461'/.test(sw))throw new Error('Service worker cache 461 is not synchronized');
