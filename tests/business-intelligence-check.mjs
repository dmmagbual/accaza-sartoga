...
if(manifest.builds.admin!==518||manifest.builds.books!==115||manifest.builds.serviceWorkerCache!==495)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v495'/.test(sw))throw new Error('Service worker cache 495 is not synchronized');
