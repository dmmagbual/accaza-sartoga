...
if(manifest.builds.admin!==441||manifest.builds.books!==97||manifest.builds.serviceWorkerCache!==404)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v404'/.test(sw))throw new Error('Service worker cache 404 is not synchronized');
