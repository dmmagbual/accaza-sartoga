...
if(manifest.builds.admin!==547||manifest.builds.books!==125||manifest.builds.serviceWorkerCache!==527)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v527'/.test(sw))throw new Error('Service worker cache is not synchronized');
