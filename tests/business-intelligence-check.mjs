...
if(manifest.builds.admin!==413||manifest.builds.books!==94||manifest.builds.serviceWorkerCache!==374)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v374'/.test(sw))throw new Error('Service worker cache 374 is not synchronized');
