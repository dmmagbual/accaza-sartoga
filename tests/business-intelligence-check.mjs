...
if(manifest.builds.admin!==539||manifest.builds.books!==121||manifest.builds.serviceWorkerCache!==517)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v517'/.test(sw))throw new Error('Service worker cache 515 is not synchronized');
