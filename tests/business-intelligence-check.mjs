...
if(manifest.builds.admin!==594||manifest.builds.books!==129||manifest.builds.serviceWorkerCache!==572)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v572'/.test(sw))throw new Error('Service worker cache is not synchronized');
