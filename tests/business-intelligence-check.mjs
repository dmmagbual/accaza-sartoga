...
if(manifest.builds.admin!==567||manifest.builds.books!==129||manifest.builds.serviceWorkerCache!==548)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v548'/.test(sw))throw new Error('Service worker cache is not synchronized');
