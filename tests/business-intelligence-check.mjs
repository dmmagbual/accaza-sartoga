...
if(manifest.builds.admin!==584||manifest.builds.books!==129||manifest.builds.serviceWorkerCache!==565)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v565'/.test(sw))throw new Error('Service worker cache is not synchronized');
