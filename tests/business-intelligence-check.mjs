...
if(manifest.builds.admin!==512||manifest.builds.books!==115||manifest.builds.serviceWorkerCache!==489)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v489'/.test(sw))throw new Error('Service worker cache 489 is not synchronized');
