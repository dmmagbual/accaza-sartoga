...
if(manifest.builds.admin!==476||manifest.builds.books!==106||manifest.builds.serviceWorkerCache!==447)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v447'/.test(sw))throw new Error('Service worker cache 447 is not synchronized');
