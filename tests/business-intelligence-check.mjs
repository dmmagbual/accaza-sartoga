...
if(manifest.builds.admin!==418||manifest.builds.books!==94||manifest.builds.serviceWorkerCache!==379)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v379'/.test(sw))throw new Error('Service worker cache 379 is not synchronized');
