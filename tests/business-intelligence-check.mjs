...
if(manifest.builds.admin!==439||manifest.builds.books!==97||manifest.builds.serviceWorkerCache!==402)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v402'/.test(sw))throw new Error('Service worker cache 402 is not synchronized');
