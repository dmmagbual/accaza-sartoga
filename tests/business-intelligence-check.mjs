...
if(manifest.builds.admin!==557||manifest.builds.books!==128||manifest.builds.serviceWorkerCache!==538)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v538'/.test(sw))throw new Error('Service worker cache is not synchronized');
