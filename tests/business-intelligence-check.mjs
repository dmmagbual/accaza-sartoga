...
if(manifest.builds.admin!==588||manifest.builds.books!==129||manifest.builds.serviceWorkerCache!==569)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v569'/.test(sw))throw new Error('Service worker cache is not synchronized');
