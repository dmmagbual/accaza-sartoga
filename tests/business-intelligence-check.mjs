...
if(manifest.builds.admin!==546||manifest.builds.books!==123||manifest.builds.serviceWorkerCache!==524)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v524'/.test(sw))throw new Error('Service worker cache is not synchronized');
