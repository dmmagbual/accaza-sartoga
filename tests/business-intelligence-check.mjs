...
if(manifest.builds.admin!==447||manifest.builds.books!==97||manifest.builds.serviceWorkerCache!==411)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v411'/.test(sw))throw new Error('Service worker cache 411 is not synchronized');
