...
if(manifest.builds.admin!==404||manifest.builds.books!==85||manifest.builds.serviceWorkerCache!==359)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v359'/.test(sw))throw new Error('Service worker cache 359 is not synchronized');
