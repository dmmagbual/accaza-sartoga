...
if(manifest.builds.admin!==497||manifest.builds.books!==109||manifest.builds.serviceWorkerCache!==472)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v472'/.test(sw))throw new Error('Service worker cache 472 is not synchronized');
