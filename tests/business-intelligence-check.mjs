...
if(manifest.builds.admin!==426||manifest.builds.books!==95||manifest.builds.serviceWorkerCache!==387)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v387'/.test(sw))throw new Error('Service worker cache 387 is not synchronized');
