...
if(manifest.builds.admin!==446||manifest.builds.books!==97||manifest.builds.serviceWorkerCache!==409)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v409'/.test(sw))throw new Error('Service worker cache 409 is not synchronized');
