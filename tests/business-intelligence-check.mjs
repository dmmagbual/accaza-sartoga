...
if(manifest.builds.admin!==486||manifest.builds.books!==107||manifest.builds.serviceWorkerCache!==458)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v458'/.test(sw))throw new Error('Service worker cache 458 is not synchronized');
