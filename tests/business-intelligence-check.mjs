...
if(manifest.builds.admin!==513||manifest.builds.books!==115||manifest.builds.serviceWorkerCache!==490)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v490'/.test(sw))throw new Error('Service worker cache 490 is not synchronized');
