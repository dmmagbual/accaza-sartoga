...
if(manifest.builds.admin!==505||manifest.builds.books!==113||manifest.builds.serviceWorkerCache!==480)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v480'/.test(sw))throw new Error('Service worker cache 480 is not synchronized');
