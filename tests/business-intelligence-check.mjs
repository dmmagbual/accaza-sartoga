...
if(manifest.builds.admin!==488||manifest.builds.books!==108||manifest.builds.serviceWorkerCache!==463)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v463'/.test(sw))throw new Error('Service worker cache 463 is not synchronized');
