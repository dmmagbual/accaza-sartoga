...
if(manifest.builds.admin!==586||manifest.builds.books!==129||manifest.builds.serviceWorkerCache!==567)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v567'/.test(sw))throw new Error('Service worker cache is not synchronized');
