...
if(manifest.builds.admin!==572||manifest.builds.books!==129||manifest.builds.serviceWorkerCache!==553)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v553'/.test(sw))throw new Error('Service worker cache is not synchronized');
