...
if(manifest.builds.admin!==550||manifest.builds.books!==126||manifest.builds.serviceWorkerCache!==530)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v530'/.test(sw))throw new Error('Service worker cache is not synchronized');
