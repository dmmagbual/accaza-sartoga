...
if(manifest.builds.admin!==562||manifest.builds.books!==128||manifest.builds.serviceWorkerCache!==543)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v543'/.test(sw))throw new Error('Service worker cache is not synchronized');
