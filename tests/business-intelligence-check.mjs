...
if(manifest.builds.admin!==483||manifest.builds.books!==107||manifest.builds.serviceWorkerCache!==455)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v455'/.test(sw))throw new Error('Service worker cache 455 is not synchronized');
