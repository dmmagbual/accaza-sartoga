...
if(manifest.builds.admin!==553||manifest.builds.books!==128||manifest.builds.serviceWorkerCache!==534)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v534'/.test(sw))throw new Error('Service worker cache is not synchronized');
