...
if(manifest.builds.admin!==469||manifest.builds.books!==106||manifest.builds.serviceWorkerCache!==440)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v440'/.test(sw))throw new Error('Service worker cache 440 is not synchronized');
