...
if(manifest.builds.admin!==467||manifest.builds.books!==105||manifest.builds.serviceWorkerCache!==438)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v438'/.test(sw))throw new Error('Service worker cache 438 is not synchronized');
