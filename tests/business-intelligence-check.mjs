...
if(manifest.builds.admin!==582||manifest.builds.books!==129||manifest.builds.serviceWorkerCache!==563)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v563'/.test(sw))throw new Error('Service worker cache is not synchronized');
