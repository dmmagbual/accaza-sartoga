...
if(manifest.builds.admin!==526||manifest.builds.books!==115||manifest.builds.serviceWorkerCache!==503)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v503'/.test(sw))throw new Error('Service worker cache 503 is not synchronized');
