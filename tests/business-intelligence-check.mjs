...
if(manifest.builds.admin!==496||manifest.builds.books!==109||manifest.builds.serviceWorkerCache!==471)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v471'/.test(sw))throw new Error('Service worker cache 471 is not synchronized');
