...
if(manifest.builds.admin!==430||manifest.builds.books!==97||manifest.builds.serviceWorkerCache!==393)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v393'/.test(sw))throw new Error('Service worker cache 393 is not synchronized');
