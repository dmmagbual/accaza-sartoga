...
if(manifest.builds.admin!==464||manifest.builds.books!==105||manifest.builds.serviceWorkerCache!==435)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v435'/.test(sw))throw new Error('Service worker cache 435 is not synchronized');
