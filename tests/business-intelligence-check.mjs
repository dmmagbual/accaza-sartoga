...
if(manifest.builds.admin!==461||manifest.builds.books!==105||manifest.builds.serviceWorkerCache!==432)throw new Error('Release manifest build markers are not synchronized');
if(!/const CACHE='accaza-v432'/.test(sw))throw new Error('Service worker cache 432 is not synchronized');
