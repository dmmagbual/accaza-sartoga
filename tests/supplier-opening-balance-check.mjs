...
for(const marker of ['App.txnSupplierOpeningBalance','App.reverseSupplierOpeningBalance','statementReference','paidBeforeOpening','confirmedOutstanding:true','openingPayableHeaderButton','openingPayableRowButton'])must(client,marker,'Supplier opening-balance UI control missing.');
