...
const retryPolicyFunctions=['preservePostedOrderOnDelete','replicateArchivedOrderToFirestore','refreshHistoricalOrderAfterJournal','refreshHistoricalOrderAfterInventoryPlan'];
