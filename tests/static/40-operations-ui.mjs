...
if(!operationsSource.includes('Production monitor:')||!operationsSource.includes('systemHealth/productionMonitor/current')||!functionsSource.includes('exports.evaluateProductionHealth = onSchedule')||!functionsSource.includes('ProductionHealth.evaluate'))fail('Phase 13 production early-warning monitor is incomplete');
