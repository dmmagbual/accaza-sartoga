...
const overviewDrinkRankingCheck=spawnSync(process.execPath,[path.join(root,'tests','overview-drink-ranking-check.mjs')],{encoding:'utf8',cwd:root});
if(overviewDrinkRankingCheck.status!==0)fail('Overview drink-ranking check failed:\n'+(overviewDrinkRankingCheck.stderr||overviewDrinkRankingCheck.stdout));
