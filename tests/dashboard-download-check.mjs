...
const compact=summarizeHistoricalSales({'2026-09':{schemaVersion:3,days:{'2026-09-01':{orders:2,grossCents:2000,discountCents:100,refundCents:0,netCents:1900,cogsCents:700,channels:{instore:{orders:2,netCents:1900}},payments:{cash:{netCents:1900}},items:{latte:{name:'Latte',categoryId:'coffee',units:2,netCents:1900}},hours:{9:{orders:2,netCents:1900}}},'2026-09-02':{orders:1,grossCents:1000,discountCents:0,refundCents:0,netCents:1000,cogsCents:300,channels:{online:{orders:1,netCents:1000}},payments:{gcash:{netCents:1000}},items:{tea:{name:'Tea',categoryId:'tea',units:1,netCents:1000}},hours:{10:{orders:1,netCents:1000}}}}}},{startAt:Date.parse('2026-09-01T00:00:00+08:00'),endAt:Date.parse('2026-09-01T23:59:59.999+08:00')});
