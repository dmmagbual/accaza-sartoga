...
assert.ok(read('assets/js/admin/portal-auth.mjs').includes("subscriptionHub.subscribe('sessionControl'") && read('assets/js/admin/portal-auth.mjs').includes('getIdTokenResult'), 'Admin/POS signs out a session older than the cutoff');
