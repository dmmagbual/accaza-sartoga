...
const actions=[
  ...
  'delete_archived_order','review_discrepancy','approve_petty_voucher','correct_petty_voucher','correct_platform_presettlement','set_undeposited_opening_balance','retire_revolving_fund','repair_closed_shift_turnover','repair_reversed_payout_deposit',
