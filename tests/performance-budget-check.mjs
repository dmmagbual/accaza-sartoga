...
if(manifest.builds.admin!==507||manifest.builds.customer!==71||manifest.builds.books!==113||manifest.builds.serviceWorkerCache!==482)fail('Current build/cache versions are not synchronized');
