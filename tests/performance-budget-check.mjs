...
const budgets={
  ...
  // Build 526 simplifies completed-sale controls while retaining the sales reconciliation bridge;
...
if(manifest.builds.admin!==526||manifest.builds.customer!==71||manifest.builds.books!==115||manifest.builds.serviceWorkerCache!==503)fail('Current build/cache versions are not synchronized');
