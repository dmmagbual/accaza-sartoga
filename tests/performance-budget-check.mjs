...
if(manifest.builds.admin!==508||manifest.builds.customer!==71||manifest.builds.books!==113||manifest.builds.serviceWorkerCache!==483)fail('Current build/cache versions are not synchronized');
