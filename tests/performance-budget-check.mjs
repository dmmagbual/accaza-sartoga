...
const budgets={
  ...
  'assets/js/admin/register.js':170000,
...
if(manifest.builds.admin!==426||manifest.builds.customer!==65||manifest.builds.books!==96||manifest.builds.serviceWorkerCache!==388)fail('Current build/cache versions are not synchronized');
