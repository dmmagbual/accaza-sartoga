...
if(manifest.builds.admin!==553||manifest.builds.customer!==74||manifest.builds.books!==128||manifest.builds.serviceWorkerCache!==534)fail('Current build/cache versions are not synchronized');
