...
if(manifest.builds.admin!==504||manifest.builds.customer!==71||manifest.builds.books!==113||manifest.builds.serviceWorkerCache!==479)fail('Current build/cache versions are not synchronized');
