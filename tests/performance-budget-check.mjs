...
if(manifest.builds.admin!==511||manifest.builds.customer!==71||manifest.builds.books!==115||manifest.builds.serviceWorkerCache!==488)fail('Current build/cache versions are not synchronized');
