...
if(manifest.builds.admin!==575||manifest.builds.customer!==75||manifest.builds.books!==129||manifest.builds.serviceWorkerCache!==556)fail('Current build/cache versions are not synchronized');
