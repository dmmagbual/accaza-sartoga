...
if(manifest.builds.admin!==397||manifest.builds.customer!==64||manifest.builds.serviceWorkerCache!==347)fail('Phase 15 build/cache versions are not synchronized');
