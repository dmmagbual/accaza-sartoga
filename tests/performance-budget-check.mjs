...
if(manifest.builds.admin!==512||manifest.builds.customer!==71||manifest.builds.books!==115||manifest.builds.serviceWorkerCache!==489)fail('Current build/cache versions are not synchronized');
