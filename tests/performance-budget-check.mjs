...
if(manifest.builds.admin!==400||manifest.builds.customer!==64||manifest.builds.serviceWorkerCache!==350)fail('Phase 18 build/cache versions are not synchronized');
