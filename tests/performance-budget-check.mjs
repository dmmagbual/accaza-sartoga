...
if(manifest.builds.admin!==423||manifest.builds.customer!==65||manifest.builds.books!==95||manifest.builds.serviceWorkerCache!==384)fail('Current build/cache versions are not synchronized');
