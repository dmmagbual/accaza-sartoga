...
if(manifest.builds.admin!==487||manifest.builds.customer!==68||manifest.builds.books!==108||manifest.builds.serviceWorkerCache!==460)fail('Current build/cache versions are not synchronized');
