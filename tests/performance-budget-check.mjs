...
if(manifest.builds.admin!==495||manifest.builds.customer!==71||manifest.builds.books!==109||manifest.builds.serviceWorkerCache!==470)fail('Current build/cache versions are not synchronized');
