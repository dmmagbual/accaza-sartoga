...
if(manifest.builds.admin!==408||manifest.builds.customer!==64||manifest.builds.books!==88||manifest.builds.serviceWorkerCache!==366)fail('Current build/cache versions are not synchronized');
