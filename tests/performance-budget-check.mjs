...
const budgets={
  ...
  // Build 463 adds recipe-unit conversion for shared ingredients and compact exclusive choice ticks.
...
if(manifest.builds.admin!==463||manifest.builds.customer!==68||manifest.builds.books!==105||manifest.builds.serviceWorkerCache!==434)fail('Current build/cache versions are not synchronized');
