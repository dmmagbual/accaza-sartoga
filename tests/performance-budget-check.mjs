...
if(manifest.builds.admin!==406||manifest.builds.customer!==64||manifest.builds.books!==85||manifest.builds.serviceWorkerCache!==361)fail('Current build/cache versions are not synchronized');
