...
if(manifest.builds.admin!==551||manifest.builds.customer!==74||manifest.builds.books!==126||manifest.builds.serviceWorkerCache!==531)fail('Current build/cache versions are not synchronized');
