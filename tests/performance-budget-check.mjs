...
if(manifest.builds.admin!==557||manifest.builds.customer!==74||manifest.builds.books!==128||manifest.builds.serviceWorkerCache!==538)fail('Current build/cache versions are not synchronized');
