...
if(manifest.builds.admin!==538||manifest.builds.customer!==73||manifest.builds.books!==121||manifest.builds.serviceWorkerCache!==516)fail('Current build/cache versions are not synchronized');
