...
if(manifest.builds.admin!==486||manifest.builds.customer!==68||manifest.builds.books!==108||manifest.builds.serviceWorkerCache!==459)fail('Current build/cache versions are not synchronized');
