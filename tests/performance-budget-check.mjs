...
const budgets={
  ...
  // Books 123 adds a bounded multi-bill supplier settlement modal and reversal path.
  'assets/js/books/app.js':223000,
...
if(manifest.builds.admin!==544||manifest.builds.customer!==73||manifest.builds.books!==123||manifest.builds.serviceWorkerCache!==522)fail('Current build/cache versions are not synchronized');
