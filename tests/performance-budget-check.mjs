...
if(manifest.builds.admin!==530||manifest.builds.customer!==71||manifest.builds.books!==115||manifest.builds.serviceWorkerCache!==507)fail('Current build/cache versions are not synchronized');
