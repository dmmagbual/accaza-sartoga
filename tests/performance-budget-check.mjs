...
if(manifest.builds.admin!==428||manifest.builds.customer!==65||manifest.builds.books!==96||manifest.builds.serviceWorkerCache!==390)fail('Current build/cache versions are not synchronized');
