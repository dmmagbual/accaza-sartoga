...
if(manifest.builds.admin!==411||manifest.builds.customer!==65||manifest.builds.books!==93||manifest.builds.serviceWorkerCache!==372)fail('Current build/cache versions are not synchronized');
