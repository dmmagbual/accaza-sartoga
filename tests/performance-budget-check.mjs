...
if(manifest.builds.admin!==404||manifest.builds.customer!==64||manifest.builds.books!==84||manifest.builds.serviceWorkerCache!==358)fail('Current build/cache versions are not synchronized');
