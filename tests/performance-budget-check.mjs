...
if(manifest.builds.admin!==487||manifest.builds.customer!==69||manifest.builds.books!==108||manifest.builds.serviceWorkerCache!==461)fail('Current build/cache versions are not synchronized');
