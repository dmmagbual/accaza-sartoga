...
if(manifest.builds.admin!==415||manifest.builds.customer!==65||manifest.builds.books!==94||manifest.builds.serviceWorkerCache!==376)fail('Current build/cache versions are not synchronized');
