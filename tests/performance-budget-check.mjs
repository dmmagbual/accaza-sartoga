...
if(manifest.builds.admin!==554||manifest.builds.customer!==74||manifest.builds.books!==128||manifest.builds.serviceWorkerCache!==535)fail('Current build/cache versions are not synchronized');
