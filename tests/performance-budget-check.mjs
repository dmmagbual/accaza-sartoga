...
if(manifest.builds.admin!==591||manifest.builds.customer!==75||manifest.builds.books!==129||manifest.builds.serviceWorkerCache!==571)fail('Current build/cache versions are not synchronized');
