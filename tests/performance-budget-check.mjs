...
if(manifest.builds.admin!==441||manifest.builds.customer!==65||manifest.builds.books!==97||manifest.builds.serviceWorkerCache!==404)fail('Current build/cache versions are not synchronized');
