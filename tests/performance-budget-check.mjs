...
if(manifest.builds.admin!==550||manifest.builds.customer!==74||manifest.builds.books!==126||manifest.builds.serviceWorkerCache!==530)fail('Current build/cache versions are not synchronized');
