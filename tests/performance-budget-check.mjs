...
if(manifest.builds.admin!==549||manifest.builds.customer!==74||manifest.builds.books!==126||manifest.builds.serviceWorkerCache!==529)fail('Current build/cache versions are not synchronized');
