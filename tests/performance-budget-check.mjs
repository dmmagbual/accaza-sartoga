...
if(manifest.builds.admin!==543||manifest.builds.customer!==73||manifest.builds.books!==123||manifest.builds.serviceWorkerCache!==521)fail('Current build/cache versions are not synchronized');
