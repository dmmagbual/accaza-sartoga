...
const budgets={
  ...
  // Build 472 costs recipes with their real menu-item context, including shared ingredients.
  // Retain a narrow ceiling so future POS growth still requires explicit review.
  'assets/js/admin/pos.js':462000,
...
if(manifest.builds.admin!==472||manifest.builds.customer!==68||manifest.builds.books!==106||manifest.builds.serviceWorkerCache!==443)fail('Current build/cache versions are not synchronized');
