...
if(manifest.builds.admin!==448||manifest.builds.customer!==67||manifest.builds.books!==99||manifest.builds.serviceWorkerCache!==414)fail('Current build/cache versions are not synchronized');
