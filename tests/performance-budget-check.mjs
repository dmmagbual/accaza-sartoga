...
if(manifest.builds.admin!==436||manifest.builds.customer!==65||manifest.builds.books!==97||manifest.builds.serviceWorkerCache!==399)fail('Current build/cache versions are not synchronized');
