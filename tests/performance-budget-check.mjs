...
if(manifest.builds.admin!==427||manifest.builds.customer!==65||manifest.builds.books!==96||manifest.builds.serviceWorkerCache!==389)fail('Current build/cache versions are not synchronized');
