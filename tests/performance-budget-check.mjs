...
if(manifest.builds.admin!==449||manifest.builds.customer!==67||manifest.builds.books!==102||manifest.builds.serviceWorkerCache!==418)fail('Current build/cache versions are not synchronized');
