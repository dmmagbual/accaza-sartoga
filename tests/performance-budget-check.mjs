...
if(manifest.builds.admin!==492||manifest.builds.customer!==70||manifest.builds.books!==109||manifest.builds.serviceWorkerCache!==467)fail('Current build/cache versions are not synchronized');
