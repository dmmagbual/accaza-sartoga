...
if(manifest.builds.admin!==444||manifest.builds.customer!==65||manifest.builds.books!==97||manifest.builds.serviceWorkerCache!==407)fail('Current build/cache versions are not synchronized');
