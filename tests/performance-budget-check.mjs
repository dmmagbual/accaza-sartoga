...
if(manifest.builds.admin!==476||manifest.builds.customer!==68||manifest.builds.books!==106||manifest.builds.serviceWorkerCache!==447)fail('Current build/cache versions are not synchronized');
