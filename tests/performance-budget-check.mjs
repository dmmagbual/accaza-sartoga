...
if(manifest.builds.admin!==408||manifest.builds.customer!==64||manifest.builds.books!==85||manifest.builds.serviceWorkerCache!==363)fail('Current build/cache versions are not synchronized');
