...
const budgets={
  ...
  // Build 473 prevents positive inventory from remaining silently uncosted.
  // Retain a narrow ceiling so future POS growth still requires explicit review.
  'assets/js/admin/pos.js':463000,
...
if(manifest.builds.admin!==473||manifest.builds.customer!==68||manifest.builds.books!==106||manifest.builds.serviceWorkerCache!==444)fail('Current build/cache versions are not synchronized');
