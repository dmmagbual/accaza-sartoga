...
const budgets={
  ...
  // Build 564 requires compact, validated monthly summaries before reporting.
...
if(manifest.builds.admin!==564||manifest.builds.customer!==74||manifest.builds.books!==129||manifest.builds.serviceWorkerCache!==545)fail('Current build/cache versions are not synchronized');
