...
if(manifest.builds.admin!==433||manifest.builds.customer!==65||manifest.builds.books!==97||manifest.builds.serviceWorkerCache!==396)fail('Current build/cache versions are not synchronized');
