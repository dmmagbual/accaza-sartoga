...
if(manifest.builds.admin!==398||manifest.builds.customer!==64||manifest.builds.serviceWorkerCache!==348)fail('Phase 16 build/cache versions are not synchronized');
