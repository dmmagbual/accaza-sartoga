...
if(manifest.builds.admin!==547||manifest.builds.customer!==73||manifest.builds.books!==125||manifest.builds.serviceWorkerCache!==527)fail('Current build/cache versions are not synchronized');
