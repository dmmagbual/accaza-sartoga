...
if(manifest.builds.admin!==396||manifest.builds.customer!==64||manifest.builds.serviceWorkerCache!==346)fail('Phase 14 build/cache versions are not synchronized');
