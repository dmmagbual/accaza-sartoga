...
if(manifest.builds.admin!==418||manifest.builds.customer!==65||manifest.builds.books!==94||manifest.builds.serviceWorkerCache!==379)fail('Current build/cache versions are not synchronized');
