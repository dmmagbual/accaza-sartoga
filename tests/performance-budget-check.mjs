...
if(manifest.builds.admin!==456||manifest.builds.customer!==68||manifest.builds.books!==105||manifest.builds.serviceWorkerCache!==427)fail('Current build/cache versions are not synchronized');
