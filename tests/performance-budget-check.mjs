...
if(manifest.builds.admin!==421||manifest.builds.customer!==65||manifest.builds.books!==95||manifest.builds.serviceWorkerCache!==382)fail('Current build/cache versions are not synchronized');
