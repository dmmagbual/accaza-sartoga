...
if(manifest.builds.admin!==528||manifest.builds.customer!==71||manifest.builds.books!==115||manifest.builds.serviceWorkerCache!==505)fail('Current build/cache versions are not synchronized');
