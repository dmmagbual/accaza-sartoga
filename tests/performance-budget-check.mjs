...
const budgets={
  ...
  // Build 467 isolates editing and storage for each selected required-choice recipe.
...
if(manifest.builds.admin!==467||manifest.builds.customer!==68||manifest.builds.books!==105||manifest.builds.serviceWorkerCache!==438)fail('Current build/cache versions are not synchronized');
