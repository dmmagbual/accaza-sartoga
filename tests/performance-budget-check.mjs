...
if(manifest.builds.admin!==505||manifest.builds.customer!==71||manifest.builds.books!==113||manifest.builds.serviceWorkerCache!==480)fail('Current build/cache versions are not synchronized');
