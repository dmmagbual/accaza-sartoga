...
if(manifest.builds.admin!==439||manifest.builds.customer!==65||manifest.builds.books!==97||manifest.builds.serviceWorkerCache!==402)fail('Current build/cache versions are not synchronized');
