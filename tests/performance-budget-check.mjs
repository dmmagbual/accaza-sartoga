...
if(manifest.builds.admin!==545||manifest.builds.customer!==73||manifest.builds.books!==123||manifest.builds.serviceWorkerCache!==523)fail('Current build/cache versions are not synchronized');
