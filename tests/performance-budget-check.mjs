...
if(manifest.builds.admin!==501||manifest.builds.customer!==71||manifest.builds.books!==111||manifest.builds.serviceWorkerCache!==476)fail('Current build/cache versions are not synchronized');
