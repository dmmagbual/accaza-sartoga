...
if(manifest.builds.admin!==438||manifest.builds.customer!==65||manifest.builds.books!==97||manifest.builds.serviceWorkerCache!==401)fail('Current build/cache versions are not synchronized');
