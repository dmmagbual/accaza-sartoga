...
if(manifest.builds.admin!==595||manifest.builds.customer!==75||manifest.builds.books!==129||manifest.builds.serviceWorkerCache!==573)fail('Current build/cache versions are not synchronized');
