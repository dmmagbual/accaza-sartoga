...
if(manifest.builds.admin!==443||manifest.builds.customer!==65||manifest.builds.books!==97||manifest.builds.serviceWorkerCache!==406)fail('Current build/cache versions are not synchronized');
