...
if(manifest.builds.admin!==516||manifest.builds.customer!==71||manifest.builds.books!==115||manifest.builds.serviceWorkerCache!==493)fail('Current build/cache versions are not synchronized');
