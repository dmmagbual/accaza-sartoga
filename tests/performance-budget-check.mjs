...
const budgets={
  ...
  // Build 480 supports temperature-scoped duplicate base ingredients.
...
if(manifest.builds.admin!==480||manifest.builds.customer!==68||manifest.builds.books!==107||manifest.builds.serviceWorkerCache!==452)fail('Current build/cache versions are not synchronized');
