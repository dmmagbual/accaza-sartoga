...
if(manifest.builds.admin!==546||manifest.builds.customer!==73||manifest.builds.books!==123||manifest.builds.serviceWorkerCache!==524)fail('Current build/cache versions are not synchronized');
