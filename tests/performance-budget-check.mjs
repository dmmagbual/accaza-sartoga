...
if(manifest.builds.admin!==555||manifest.builds.customer!==74||manifest.builds.books!==128||manifest.builds.serviceWorkerCache!==536)fail('Current build/cache versions are not synchronized');
