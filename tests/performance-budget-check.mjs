...
if(manifest.builds.admin!==440||manifest.builds.customer!==65||manifest.builds.books!==97||manifest.builds.serviceWorkerCache!==403)fail('Current build/cache versions are not synchronized');
