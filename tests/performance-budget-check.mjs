...
if(manifest.builds.admin!==537||manifest.builds.customer!==73||manifest.builds.books!==120||manifest.builds.serviceWorkerCache!==515)fail('Current build/cache versions are not synchronized');
