...
if(manifest.builds.admin!==534||manifest.builds.customer!==71||manifest.builds.books!==116||manifest.builds.serviceWorkerCache!==511)fail('Current build/cache versions are not synchronized');
