...
if(manifest.builds.admin!==432||manifest.builds.customer!==65||manifest.builds.books!==97||manifest.builds.serviceWorkerCache!==395)fail('Current build/cache versions are not synchronized');
