...
if(manifest.builds.admin!==547||manifest.builds.customer!==73||manifest.builds.books!==124||manifest.builds.serviceWorkerCache!==526)fail('Current build/cache versions are not synchronized');
