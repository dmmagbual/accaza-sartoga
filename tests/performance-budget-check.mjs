...
if(manifest.builds.admin!==485||manifest.builds.customer!==68||manifest.builds.books!==107||manifest.builds.serviceWorkerCache!==457)fail('Current build/cache versions are not synchronized');
