...
if(manifest.builds.admin!==551||manifest.builds.customer!==74||manifest.builds.books!==127||manifest.builds.serviceWorkerCache!==532)fail('Current build/cache versions are not synchronized');
