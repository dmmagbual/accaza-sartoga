...
const budgets={
  ...
  // Build 478 scopes duplicate shared-choice ingredients by temperature.
...
if(manifest.builds.admin!==478||manifest.builds.customer!==68||manifest.builds.books!==107||manifest.builds.serviceWorkerCache!==450)fail('Current build/cache versions are not synchronized');
