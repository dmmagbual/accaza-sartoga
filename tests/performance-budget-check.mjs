...
if(manifest.builds.admin!==400||manifest.builds.customer!==64||manifest.builds.books!==79||manifest.builds.serviceWorkerCache!==352)fail('Current build/cache versions are not synchronized');
