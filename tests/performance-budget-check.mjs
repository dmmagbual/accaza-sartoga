...
if(manifest.builds.admin!==416||manifest.builds.customer!==65||manifest.builds.books!==94||manifest.builds.serviceWorkerCache!==377)fail('Current build/cache versions are not synchronized');
