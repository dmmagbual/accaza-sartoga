...
if(manifest.builds.admin!==407||manifest.builds.customer!==64||manifest.builds.books!==85||manifest.builds.serviceWorkerCache!==362)fail('Current build/cache versions are not synchronized');
