...
if(manifest.builds.admin!==542||manifest.builds.customer!==73||manifest.builds.books!==123||manifest.builds.serviceWorkerCache!==520)fail('Current build/cache versions are not synchronized');
