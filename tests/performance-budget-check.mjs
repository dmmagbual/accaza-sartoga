...
if(manifest.builds.admin!==458||manifest.builds.customer!==68||manifest.builds.books!==105||manifest.builds.serviceWorkerCache!==429)fail('Current build/cache versions are not synchronized');
