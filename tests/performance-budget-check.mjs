...
if(manifest.builds.admin!==510||manifest.builds.customer!==71||manifest.builds.books!==113||manifest.builds.serviceWorkerCache!==485)fail('Current build/cache versions are not synchronized');
