...
if(manifest.builds.admin!==494||manifest.builds.customer!==70||manifest.builds.books!==109||manifest.builds.serviceWorkerCache!==469)fail('Current build/cache versions are not synchronized');
