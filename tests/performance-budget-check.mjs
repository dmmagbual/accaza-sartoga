...
if(manifest.builds.admin!==533||manifest.builds.customer!==71||manifest.builds.books!==116||manifest.builds.serviceWorkerCache!==510)fail('Current build/cache versions are not synchronized');
