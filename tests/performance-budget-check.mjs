...
if(manifest.builds.admin!==442||manifest.builds.customer!==65||manifest.builds.books!==97||manifest.builds.serviceWorkerCache!==405)fail('Current build/cache versions are not synchronized');
