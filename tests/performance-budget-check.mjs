...
const budgets={
  ...
  // Build 561 adds lazy-loaded MTD/YTD cashier, weekday and peak-hour analytics plus
  // a compact historical-summary readiness guard. Reviewed generated size: 172,939 bytes.
  'assets/js/admin/analytics.js':173200,
