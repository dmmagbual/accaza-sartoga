...
if(manifest.builds.admin!==571||manifest.builds.customer!==74||manifest.builds.books!==129||manifest.builds.serviceWorkerCache!==552)fail('Current build/cache versions are not synchronized');
