...
if(manifest.builds.admin!==405||manifest.builds.customer!==64||manifest.builds.books!==85||manifest.builds.serviceWorkerCache!==360)fail('Current build/cache versions are not synchronized');
