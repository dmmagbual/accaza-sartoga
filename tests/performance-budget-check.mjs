...
if(manifest.builds.admin!==420||manifest.builds.customer!==65||manifest.builds.books!==95||manifest.builds.serviceWorkerCache!==381)fail('Current build/cache versions are not synchronized');
