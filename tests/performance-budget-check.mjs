...
const budgets={
  ...
  // Build 484 adds recipe-unit display metadata without changing stock-unit costing.
...
if(manifest.builds.admin!==484||manifest.builds.customer!==68||manifest.builds.books!==107||manifest.builds.serviceWorkerCache!==456)fail('Current build/cache versions are not synchronized');
