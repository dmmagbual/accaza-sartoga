...
const budgets={
  ...
  // Build 563 requires compact, validated monthly summaries before reporting.
...
if(manifest.builds.admin!==563||manifest.builds.customer!==74||manifest.builds.books!==128||manifest.builds.serviceWorkerCache!==544)fail('Current build/cache versions are not synchronized');
