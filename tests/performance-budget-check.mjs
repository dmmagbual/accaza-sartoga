...
if(manifest.builds.admin!==448||manifest.builds.customer!==67||manifest.builds.books!==101||manifest.builds.serviceWorkerCache!==416)fail('Current build/cache versions are not synchronized');
