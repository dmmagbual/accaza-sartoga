...
if(manifest.builds.admin!==422||manifest.builds.customer!==65||manifest.builds.books!==95||manifest.builds.serviceWorkerCache!==383)fail('Current build/cache versions are not synchronized');
