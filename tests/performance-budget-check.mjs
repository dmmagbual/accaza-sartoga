...
if(manifest.builds.admin!==430||manifest.builds.customer!==65||manifest.builds.books!==97||manifest.builds.serviceWorkerCache!==393)fail('Current build/cache versions are not synchronized');
