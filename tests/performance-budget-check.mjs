...
if(manifest.builds.admin!==511||manifest.builds.customer!==71||manifest.builds.books!==113||manifest.builds.serviceWorkerCache!==486)fail('Current build/cache versions are not synchronized');
