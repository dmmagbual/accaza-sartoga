...
if(manifest.builds.admin!==491||manifest.builds.customer!==70||manifest.builds.books!==108||manifest.builds.serviceWorkerCache!==466)fail('Current build/cache versions are not synchronized');
