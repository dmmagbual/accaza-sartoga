...
if(manifest.builds.admin!==395||manifest.builds.customer!==64||manifest.builds.serviceWorkerCache!==345)fail('Phase 13 build/cache versions are not synchronized');
