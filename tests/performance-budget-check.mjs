...
if(manifest.builds.admin!==583||manifest.builds.customer!==75||manifest.builds.books!==129||manifest.builds.serviceWorkerCache!==564)fail('Current build/cache versions are not synchronized');
