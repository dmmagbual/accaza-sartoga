...
if(manifest.builds.admin!==426||manifest.builds.customer!==65||manifest.builds.books!==95||manifest.builds.serviceWorkerCache!==387)fail('Current build/cache versions are not synchronized');
