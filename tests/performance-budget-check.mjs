...
const budgets={
  ...
  // Build 474 scopes shared-choice overrides to the selected temperature.
  // Retain a narrow ceiling so future POS growth still requires explicit review.
  'assets/js/admin/pos.js':464000,
...
if(manifest.builds.admin!==474||manifest.builds.customer!==68||manifest.builds.books!==106||manifest.builds.serviceWorkerCache!==445)fail('Current build/cache versions are not synchronized');
