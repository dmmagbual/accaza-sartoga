...
if(manifest.builds.admin!==509||manifest.builds.customer!==71||manifest.builds.books!==113||manifest.builds.serviceWorkerCache!==484)fail('Current build/cache versions are not synchronized');
