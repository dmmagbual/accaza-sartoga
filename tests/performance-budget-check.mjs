...
if(manifest.builds.admin!==437||manifest.builds.customer!==65||manifest.builds.books!==97||manifest.builds.serviceWorkerCache!==400)fail('Current build/cache versions are not synchronized');
