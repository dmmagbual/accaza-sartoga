...
if(manifest.builds.admin!==513||manifest.builds.customer!==71||manifest.builds.books!==115||manifest.builds.serviceWorkerCache!==490)fail('Current build/cache versions are not synchronized');
