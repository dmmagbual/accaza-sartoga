...
const budgets={
  ...
  // Build 470 bounds shared-choice save feedback when Firebase acknowledgements stall.
...
if(manifest.builds.admin!==470||manifest.builds.customer!==68||manifest.builds.books!==106||manifest.builds.serviceWorkerCache!==441)fail('Current build/cache versions are not synchronized');
