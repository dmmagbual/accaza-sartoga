...
if(manifest.builds.admin!==409||manifest.builds.customer!==64||manifest.builds.books!==89||manifest.builds.serviceWorkerCache!==367)fail('Current build/cache versions are not synchronized');
