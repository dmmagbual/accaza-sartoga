...
if(manifest.builds.admin!==457||manifest.builds.customer!==68||manifest.builds.books!==105||manifest.builds.serviceWorkerCache!==428)fail('Current build/cache versions are not synchronized');
