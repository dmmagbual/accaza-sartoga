...
const budgets={
  ...
  // Build 461 adds shared-base inheritance and the three-size effective-recipe inspector.
  // Retain a narrow ceiling so future POS growth still requires explicit review.
  'assets/js/admin/pos.js':449000,
...
if(manifest.builds.admin!==461||manifest.builds.customer!==68||manifest.builds.books!==105||manifest.builds.serviceWorkerCache!==432)fail('Current build/cache versions are not synchronized');
