...
if(manifest.builds.admin!==506||manifest.builds.customer!==71||manifest.builds.books!==113||manifest.builds.serviceWorkerCache!==481)fail('Current build/cache versions are not synchronized');
