...
const budgets={
  ...
  // Build 475 adds explicit Hot/Iced applicability controls for shared-choice overrides.
  // Retain a narrow ceiling so future POS growth still requires explicit review.
  'assets/js/admin/pos.js':466000,
...
if(manifest.builds.admin!==475||manifest.builds.customer!==68||manifest.builds.books!==106||manifest.builds.serviceWorkerCache!==446)fail('Current build/cache versions are not synchronized');
