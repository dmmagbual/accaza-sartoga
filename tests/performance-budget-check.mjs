...
if(manifest.builds.admin!==400||manifest.builds.customer!==64||manifest.builds.books!==78||manifest.builds.serviceWorkerCache!==351)fail('Current build/cache versions are not synchronized');
