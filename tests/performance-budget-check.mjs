...
if(manifest.builds.admin!==531||manifest.builds.customer!==71||manifest.builds.books!==115||manifest.builds.serviceWorkerCache!==508)fail('Current build/cache versions are not synchronized');
