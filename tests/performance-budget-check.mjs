...
if(manifest.builds.admin!==587||manifest.builds.customer!==75||manifest.builds.books!==129||manifest.builds.serviceWorkerCache!==568)fail('Current build/cache versions are not synchronized');
