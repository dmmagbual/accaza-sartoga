...
if(manifest.builds.admin!==572||manifest.builds.customer!==74||manifest.builds.books!==129||manifest.builds.serviceWorkerCache!==553)fail('Current build/cache versions are not synchronized');
