...
if(manifest.builds.admin!==446||manifest.builds.customer!==67||manifest.builds.books!==97||manifest.builds.serviceWorkerCache!==410)fail('Current build/cache versions are not synchronized');
