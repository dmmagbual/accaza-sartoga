...
if(manifest.builds.admin!==476||manifest.builds.customer!==68||manifest.builds.books!==107||manifest.builds.serviceWorkerCache!==448)fail('Current build/cache versions are not synchronized');
