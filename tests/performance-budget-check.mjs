...
if(manifest.builds.admin!==515||manifest.builds.customer!==71||manifest.builds.books!==115||manifest.builds.serviceWorkerCache!==492)fail('Current build/cache versions are not synchronized');
