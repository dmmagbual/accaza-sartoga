...
if(manifest.builds.admin!==399||manifest.builds.customer!==64||manifest.builds.serviceWorkerCache!==349)fail('Phase 17 build/cache versions are not synchronized');
