...
if(manifest.builds.admin!==552||manifest.builds.customer!==74||manifest.builds.books!==128||manifest.builds.serviceWorkerCache!==533)fail('Current build/cache versions are not synchronized');
