...
if(manifest.builds.admin!==403||manifest.builds.customer!==64||manifest.builds.books!==83||manifest.builds.serviceWorkerCache!==356)fail('Current build/cache versions are not synchronized');
