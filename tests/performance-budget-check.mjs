...
if(manifest.builds.admin!==529||manifest.builds.customer!==71||manifest.builds.books!==115||manifest.builds.serviceWorkerCache!==506)fail('Current build/cache versions are not synchronized');
