...
if(manifest.builds.admin!==502||manifest.builds.customer!==71||manifest.builds.books!==112||manifest.builds.serviceWorkerCache!==477)fail('Current build/cache versions are not synchronized');
