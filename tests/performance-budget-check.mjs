...
if(manifest.builds.admin!==449||manifest.builds.customer!==67||manifest.builds.books!==101||manifest.builds.serviceWorkerCache!==417)fail('Current build/cache versions are not synchronized');
