...
if(manifest.builds.admin!==520||manifest.builds.customer!==71||manifest.builds.books!==115||manifest.builds.serviceWorkerCache!==497)fail('Current build/cache versions are not synchronized');
