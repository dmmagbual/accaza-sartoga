...
if(manifest.builds.admin!==570||manifest.builds.customer!==74||manifest.builds.books!==129||manifest.builds.serviceWorkerCache!==551)fail('Current build/cache versions are not synchronized');
