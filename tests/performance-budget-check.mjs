...
const budgets={
  ...
  'assets/js/admin/register.js':222000,
...
if(manifest.builds.admin!==594||manifest.builds.customer!==75||manifest.builds.books!==129||manifest.builds.serviceWorkerCache!==572)fail('Current build/cache versions are not synchronized');
