...
if(manifest.builds.admin!==413||manifest.builds.customer!==65||manifest.builds.books!==94||manifest.builds.serviceWorkerCache!==374)fail('Current build/cache versions are not synchronized');
