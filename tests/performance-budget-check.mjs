...
if(manifest.builds.admin!==586||manifest.builds.customer!==75||manifest.builds.books!==129||manifest.builds.serviceWorkerCache!==567)fail('Current build/cache versions are not synchronized');
