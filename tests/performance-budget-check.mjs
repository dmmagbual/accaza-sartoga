...
if(manifest.builds.admin!==486||manifest.builds.customer!==68||manifest.builds.books!==107||manifest.builds.serviceWorkerCache!==458)fail('Current build/cache versions are not synchronized');
