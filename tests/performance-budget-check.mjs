...
if(manifest.builds.admin!==559||manifest.builds.customer!==74||manifest.builds.books!==128||manifest.builds.serviceWorkerCache!==540)fail('Current build/cache versions are not synchronized');
