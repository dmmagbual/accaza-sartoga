...
if(manifest.builds.admin!==408||manifest.builds.customer!==64||manifest.builds.books!==86||manifest.builds.serviceWorkerCache!==364)fail('Current build/cache versions are not synchronized');
