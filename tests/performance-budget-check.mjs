...
if(manifest.builds.admin!==419||manifest.builds.customer!==65||manifest.builds.books!==94||manifest.builds.serviceWorkerCache!==380)fail('Current build/cache versions are not synchronized');
