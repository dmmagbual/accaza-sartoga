...
if(manifest.builds.admin!==558||manifest.builds.customer!==74||manifest.builds.books!==128||manifest.builds.serviceWorkerCache!==539)fail('Current build/cache versions are not synchronized');
