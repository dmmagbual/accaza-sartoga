...
if(manifest.builds.admin!==408||manifest.builds.customer!==64||manifest.builds.books!==87||manifest.builds.serviceWorkerCache!==365)fail('Current build/cache versions are not synchronized');
