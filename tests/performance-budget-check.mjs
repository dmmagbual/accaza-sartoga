...
if(manifest.builds.admin!==546||manifest.builds.customer!==73||manifest.builds.books!==124||manifest.builds.serviceWorkerCache!==525)fail('Current build/cache versions are not synchronized');
