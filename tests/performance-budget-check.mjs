...
const budgets={
  ...
  // Build 477 scopes recipe-specific ingredients to the selected temperature.
  // Retain a narrow ceiling so future POS growth still requires explicit review.
  'assets/js/admin/pos.js':471000,
...
if(manifest.builds.admin!==477||manifest.builds.customer!==68||manifest.builds.books!==107||manifest.builds.serviceWorkerCache!==449)fail('Current build/cache versions are not synchronized');
