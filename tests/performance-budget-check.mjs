...
if(manifest.builds.admin!==394||manifest.builds.customer!==64||manifest.builds.serviceWorkerCache!==344)fail('Phase 11 build/cache versions are not synchronized');
