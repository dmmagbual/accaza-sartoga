...
if(manifest.builds.admin!==414||manifest.builds.customer!==65||manifest.builds.books!==94||manifest.builds.serviceWorkerCache!==375)fail('Current build/cache versions are not synchronized');
