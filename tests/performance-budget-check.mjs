...
const budgets={
  ...
  // Build 464 separates effective base, packaging and selected additional ingredients.
...
if(manifest.builds.admin!==464||manifest.builds.customer!==68||manifest.builds.books!==105||manifest.builds.serviceWorkerCache!==435)fail('Current build/cache versions are not synchronized');
