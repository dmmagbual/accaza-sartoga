...
if(manifest.builds.admin!==459||manifest.builds.customer!==68||manifest.builds.books!==105||manifest.builds.serviceWorkerCache!==430)fail('Current build/cache versions are not synchronized');
