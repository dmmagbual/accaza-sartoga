...
if(manifest.builds.admin!==493||manifest.builds.customer!==70||manifest.builds.books!==109||manifest.builds.serviceWorkerCache!==468)fail('Current build/cache versions are not synchronized');
