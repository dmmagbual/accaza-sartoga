...
const budgets={
  ...
  // Build 471 routes shared-choice saves through an authenticated server command.
...
if(manifest.builds.admin!==471||manifest.builds.customer!==68||manifest.builds.books!==106||manifest.builds.serviceWorkerCache!==442)fail('Current build/cache versions are not synchronized');
