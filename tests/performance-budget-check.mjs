...
if(manifest.builds.admin!==447||manifest.builds.customer!==67||manifest.builds.books!==98||manifest.builds.serviceWorkerCache!==412)fail('Current build/cache versions are not synchronized');
