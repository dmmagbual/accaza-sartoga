...
if(manifest.builds.admin!==404||manifest.builds.customer!==64||manifest.builds.books!==85||manifest.builds.serviceWorkerCache!==359)fail('Current build/cache versions are not synchronized');
