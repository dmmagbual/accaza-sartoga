...
if(manifest.builds.admin!==567||manifest.builds.customer!==74||manifest.builds.books!==129||manifest.builds.serviceWorkerCache!==548)fail('Current build/cache versions are not synchronized');
