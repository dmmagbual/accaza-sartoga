...
if(manifest.builds.admin!==401||manifest.builds.customer!==64||manifest.builds.books!==80||manifest.builds.serviceWorkerCache!==353)fail('Current build/cache versions are not synchronized');
