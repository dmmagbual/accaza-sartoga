...
if(manifest.builds.admin!==417||manifest.builds.customer!==65||manifest.builds.books!==94||manifest.builds.serviceWorkerCache!==378)fail('Current build/cache versions are not synchronized');
