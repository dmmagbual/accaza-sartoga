...
const budgets={
  ...
  // Build 479 supports complete recipes defined only by Hot and Iced choices.
  // Retain a narrow ceiling so future POS growth still requires explicit review.
  'assets/js/admin/pos.js':474000,
...
if(manifest.builds.admin!==479||manifest.builds.customer!==68||manifest.builds.books!==107||manifest.builds.serviceWorkerCache!==451)fail('Current build/cache versions are not synchronized');
