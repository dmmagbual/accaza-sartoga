...
if(manifest.builds.admin!==410||manifest.builds.customer!==65||manifest.builds.books!==93||manifest.builds.serviceWorkerCache!==371)fail('Current build/cache versions are not synchronized');
