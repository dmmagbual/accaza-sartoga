...
if(manifest.builds.admin!==514||manifest.builds.customer!==71||manifest.builds.books!==115||manifest.builds.serviceWorkerCache!==491)fail('Current build/cache versions are not synchronized');
