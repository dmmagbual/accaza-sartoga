...
const budgets={
  ...
  // Build 462 aligns the effective-recipe inspector with row-level overrides and compact choice controls.
  // Retain a narrow ceiling so future POS growth still requires explicit review.
  'assets/js/admin/pos.js':454000,
...
if(manifest.builds.admin!==462||manifest.builds.customer!==68||manifest.builds.books!==105||manifest.builds.serviceWorkerCache!==433)fail('Current build/cache versions are not synchronized');
