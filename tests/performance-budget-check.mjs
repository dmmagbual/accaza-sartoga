...
if(manifest.builds.admin!==447||manifest.builds.customer!==67||manifest.builds.books!==97||manifest.builds.serviceWorkerCache!==411)fail('Current build/cache versions are not synchronized');
