...
if(manifest.builds.admin!==435||manifest.builds.customer!==65||manifest.builds.books!==97||manifest.builds.serviceWorkerCache!==398)fail('Current build/cache versions are not synchronized');
