...
if(manifest.builds.admin!==556||manifest.builds.customer!==74||manifest.builds.books!==128||manifest.builds.serviceWorkerCache!==537)fail('Current build/cache versions are not synchronized');
