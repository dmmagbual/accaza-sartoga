...
if(manifest.builds.admin!==517||manifest.builds.customer!==71||manifest.builds.books!==115||manifest.builds.serviceWorkerCache!==494)fail('Current build/cache versions are not synchronized');
