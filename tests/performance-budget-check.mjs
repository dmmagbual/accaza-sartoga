...
const budgets={
  ...
  // Build 489 keeps flat-serving pastry costing while replacing item assignments with one inherited category set.
...
if(manifest.builds.admin!==489||manifest.builds.customer!==70||manifest.builds.books!==108||manifest.builds.serviceWorkerCache!==464)fail('Current build/cache versions are not synchronized');
