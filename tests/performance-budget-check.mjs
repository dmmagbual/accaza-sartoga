...
if(manifest.builds.admin!==403||manifest.builds.customer!==64||manifest.builds.books!==82||manifest.builds.serviceWorkerCache!==355)fail('Current build/cache versions are not synchronized');
