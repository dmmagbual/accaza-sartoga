(function(root,factory){
  ...
  function costRecipe(args){args=args||{};var key=args.itemKey||'item',item=Object.assign({key:key},args.item||{});return costOrder({lineItems:[{itemKey:key,size:args.size||'M',qty:args.qty||1,optLabels:args.optLabels||[]}],recipes:(function(){var o={};o[key]=args.recipe;return o;})(),inventory:args.inventory||{},menuItems:(function(){var o={};o[key]=item;return o;})(),sharedBaseIngredients:args.sharedBaseIngredients||{},optionCosts:args.optionCosts||{},optionRecipes:args.optionRecipes||{},optionGroups:args.optionGroups||{},packagingRules:args.packagingRules||{},packagingAssignments:args.packagingAssignments||{}});}
