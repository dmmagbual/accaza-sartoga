...
const PAGES = {
  ...
  cashflow(){
    ...
    return `<div class="page-head"><div><h2>Cash Flow</h2><p>Authoritative cash statement · moved from Admin</p></div><div class="btn-row">${csvButton('cashflow')}<button class="btn" onclick="App.go('transactions')">Record transaction</button><button class="btn primary" onclick="App.cashAccountEdit('')">+ Cash account</button></div></div>
      <div class="hint">Opening cash is the amount held at the end of the day before this report starts. Funds first recorded on the From date appear as cash received during the period. Transfers between Register Cash, Undeposited Collection and a bank stay in the audit trail but are excluded here because they do not increase or reduce total cash.</div>
