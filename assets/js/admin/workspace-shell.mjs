const META={
  ...
  inventory:['Supplies & recipes','Stock items','Maintain the common stock items, approved brands, and quantities used by recipes.','purchases:Record purchase'],
  ...
  petty:['Financials','Cash payments','Record approved expenses, owner withdrawals, and supplier payments from Undeposited Collection.','undeposited:View cash pool'],
  undeposited:['Financials','Undeposited Collection','Reconcile cash on hand, approved payments, and amounts awaiting bank deposit.','petty:Record cash payment'],
