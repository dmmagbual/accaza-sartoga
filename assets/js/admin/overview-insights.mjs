...
function createOverviewInsights(deps){
  var state={metric:'units',latest:null,bound:false,rankingFrom:'',rankingTo:'',rankingOpen:false,lastFocus:null,rankingSales:null,rankingKey:'',rankingRequest:0,rankingError:'',yearSales:null,yearKey:'',yearRequest:0,yearError:''};
  ...
  function loadYear(){
    ...
    if(deps.watchRollingSales)state.stopYear=deps.watchRollingSales(r,received,failed);
...
export{buildChannelBreakdown,buildDrinkRanking,buildRollingYear,createOverviewHistoryLoader,createOverviewInsights,mergeOverviewOrders,overviewChannelKey,overviewDayRange,overviewRankingRange,overviewRollingYearRange};
