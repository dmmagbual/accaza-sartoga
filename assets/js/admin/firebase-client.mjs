...
const callableNames=['getPaymentProof','confirmOrderReceived','ensureActiveOrders','updateOrderStatus','acceptOnlineOrder','getOperationalExceptions','postInventoryMovements','ensureInventoryLedger','validateRecipeDefinition','postFinancialCommand','reconcilePurchasePayable','managePurchaseCorrection','settlePlatformPayout','processOrderAdjustment','ensureFinancialLedger','manageCashAccount','createManagerApproval','consumeManagerApproval','manageChartAccount','auditFinancialControls','manageOrderArchive','reviewDiscrepancy','managePettyVoucher','archiveActivityLog','syncOfflinePosSale','recordClientTelemetry','recordPlatformCatchup','correctPlatformPresettlement','reversePlatformPayout','setPlatformPayoutDate'];
