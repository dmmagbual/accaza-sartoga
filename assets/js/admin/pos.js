...
function allSuppliersForList(){return Object.keys(supplierMap).map(function(id){return Object.assign({id:id},supplierMap[id]);}).filter(function(x){return !x.mergedInto;}).sort(function(a,b){return String(a.name||'').localeCompare(String(b.name||''),undefined,{sensitivity:'base'});});}
