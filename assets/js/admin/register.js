...
function renderPetty(){
  ...
  root.innerHTML='<div class="pz-h">💵 Cash Payments</div>'
    +'<p class="pz-sub">Approved payments are charged to the selected cash, bank, or e-wallet account. Choose the controlled debit treatment: operating expense, owner withdrawal, supplier advance, loan repayment, staff advance, or settlement of an existing customer refund payable. A receipt or clear manager-reviewed explanation is required.</p>'
