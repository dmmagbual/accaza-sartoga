(function(){
'use strict';
var staffList={},activeShift=null,shiftsMap={},activityMap={},heldMap={},ordersMap={},discMap={},booksChartMap={},cashAccountsMap={},toleranceCfg={cashPeso:20,invPct:5},fixedFloatCfg=null,logCollapsed=true,cardShiftId=null;
...
function cashDifferenceCase(id,d){
  ...
  function detailFields(t,amount){var date=window.AccazaDate.key();
    if(t==='cash_recovered')return[{name:'destination',label:'Where was the recovered cash placed?',type:'select',required:true,value:'undeposited',options:cashOpts()},{name:'correctionMovementId',label:'Existing Finance movement (optional — exact match is detected automatically)',placeholder:'books_manual_…'},{name:'date',label:'Recovery date',type:'date',required:true,value:date}];
