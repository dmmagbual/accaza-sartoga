...
function cashDifferenceCase(id,d){
  ...
  function detailFields(t,amount){var date=window.AccazaDate.key();
    ...
    return[{name:'correctedCount',label:'Corrected physical cash count ₱',type:'number',required:true,min:0,step:.01},{name:'evidence',label:'Recount evidence and who verified it',type:'textarea',required:true}];
  }
