...
function createSubscriptionHub(database,ops){
  ...
  var scopes={
    ...
    pettyCashVouchers:['petty'],pettyCashReplenishments:['petty'],pettyCashSettings:['petty'],cfAccounts:['purchases','cashflow','receivables','payables'],cfLedger:['cashflow'],'books/journal':['stockvalue'],financialMovements:['purchases','cashflow','receivables','payables','payouts','saleshistory'],chartOfAccounts:['cashflow'],cashCustody:['cashflow'],receivables:['receivables'],payables:['payables']
  };
