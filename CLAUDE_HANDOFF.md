...
**Local builds:** admin v169, customer v45, service-worker cache v58  
...
- PWA: separate customer and POS manifests; one service worker with coordinated cache v58.
...
1. v169 production smoke test passes on the cashier device.
...
- Production timing evidence for v169 is pending; local tests cannot prove real cashier-device speed.
