...
**Local builds:** admin v171, customer v45, service-worker cache v60  
...
- PWA: separate customer and POS manifests; one service worker with coordinated cache v60.
...
1. v171 production smoke test passes on the cashier device.
...
- Production timing evidence for v171 is pending; local tests cannot prove real cashier-device speed.
