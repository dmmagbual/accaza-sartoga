...
- `admin.html`: **v177 Release 7H deployment pending**. Hash must be recaptured after final packaging.
...
- `sw.js`: **cache v74**, including Release 7H and all earlier PWA assets. Hash must be recaptured after final packaging.
